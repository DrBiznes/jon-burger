...
const FloatingDock: React.FC = () => {
  return (
    <footer className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-3xl">
      <div className="bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900 p-3 sm:p-4 shadow-2xl border-2 border-gray-700 dark:border-gray-300">
        <ul className="grid grid-cols-2 sm:flex sm:flex-row gap-x-4 sm:gap-x-6 gap-y-2 items-center justify-center font-mono text-sm sm:text-base">
          {menuItems.map(item => (
            <li key={item.name} className="flex justify-between items-center sm:block">
